...
<template>
  <div v-if="movieStore.movies.length" class="relative z-1">
   <button class="bg-gray-600 p-2 px-4 rounded flex items-center cursor-pointer" @click="isShow = !isShow">
    ...
    <transition name="dropdown">
      <div v-if="isShow" class="absolute right-0 bg-gray-600 text-gray-200 flex flex-col left-0 top-11 rounded z-1">
